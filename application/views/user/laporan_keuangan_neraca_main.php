        ...
        <div class="col mb-5 mb-xl-0">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col my-3">
                  <form action="<?= base_url('laporan_keuangan/neraca/detail') ?>" method="post" class="d-flex flex-row justify-content-end">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td scope="col">
                        <?= form_open('laporan_keuangan/neraca/detail', '', ['bulan' => $bulan, 'tahun' => $tahun]) ?>
