  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?= base_url('laporan_keuangan/neraca') ?>">&laquo <?= $titleTag; ?></a>
        <!-- Form -->
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Laporan Neraca <?= bulan($bulan); ?> Tahun <?= $tahun; ?></h3>
                  <?= form_open('laporan/excel/neraca', '', ['bulan' => $bulan, 'tahun' => $tahun]) ?>
