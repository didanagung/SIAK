  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?= base_url('jurnal_penyesuaian') ?>">Jurnal Penyesuaian</a>
        <!-- Form -->
        ...
        <div class="col mb-5 mb-xl-0">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col my-3">
                  <a href="<?= base_url('jurnal_penyesuaian/tambah') ?>" class="btn btn-primary mt-2">Tambah Jurnal Penyesuaian</a>
                </div>
                <div class="col my-3">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td scope="col">
                        <?= form_open('jurnal_penyesuaian/detail', '', ['bulan' => $bulan, 'tahun' => $tahun]) ?>
