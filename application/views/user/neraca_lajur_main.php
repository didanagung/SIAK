  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?= base_url('neraca_lajur') ?>"><?= $titleTag; ?></a>
        <!-- Form -->
        ...
        <div class="col mb-5 mb-xl-0">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <div class="row">
                <div class="col my-3">
                  <form action="<?= base_url('neraca_lajur/detail') ?>" method="post" class="d-flex flex-row justify-content-center">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td scope="col">
                        <?= form_open('neraca_lajur/detail', '', ['bulan' => $bulan, 'tahun' => $tahun]) ?>
                        <?= form_button(['type' => 'submit', 'content' => 'Lihat Neraca Lajur', 'class' => 'btn btn-success mr-3']) ?>
                        <?= form_close() ?>
                      </td>
                    </tr>
                  <?php
